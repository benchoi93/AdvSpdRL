...
=======
                      (sig.get_greentime(int(self.timestep*self.dt))[0] / self.dt - self.timestep*self.dt) / sig.cycle_length,
                      (sig.get_greentime(int(self.timestep*self.dt))[1] / self.dt - self.timestep*self.dt) / sig.cycle_length
>>>>>>> 279749fe995e322b0fa21f8f8e15e0b3ffcea26a
                      ]
